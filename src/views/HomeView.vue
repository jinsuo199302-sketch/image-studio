...
const TOOL_TABS = [
  ...
  { key: 'ppt-tools', label: 'PPT 工具', desc: '大纲/图片一键生成PPT', enabled: true, route: '/ai-tools?tab=ppt' },
  ...
  { key: 'ai-editimg', label: 'AI 改图', desc: '文字描述，涂抹区域或整图重绘', enabled: true, route: '/ai-tools?tab=editimg' },
  { key: 'ai-expand', label: 'AI 扩图', desc: '向外延伸画面，AI 自动补全', enabled: true, route: '/ai-tools?tab=expand' },
