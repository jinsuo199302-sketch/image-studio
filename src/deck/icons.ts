...
export const ICONS: Record<string, string> = {
  ...
  "bus": "<path d=\"M4 17a2 2 0 1 0 4 0a2 2 0 1 0 -4 0\" /> <path d=\"M16 17a2 2 0 1 0 4 0a2 2 0 1 0 -4 0\" /> <path d=\"M4 17h-2v-11a1 1 0 0 1 1 -1h14a5 7 0 0 1 5 7v5h-2m-4 0h-8\" /> <path d=\"M16 5l1.5 7l4.5 0\" /> <path d=\"M2 10l15 0\" /> <path d=\"M7 5l0 5\" /> <path d=\"M12 5l0 5\" />",
  "plane": "<path d=\"M16 10h4a2 2 0 0 1 0 4h-4l-4 7h-3l2 -7h-4l-2 2h-3l2 -4l-2 -4h3l2 2h4l-2 -7h3l4 7\" />",
  "building-factory": "<path d=\"M4 21c1.147 -4.02 1.983 -8.027 2 -12h6c.017 3.973 .853 7.98 2 12\" /> <path d=\"M12.5 13h4.5c.025 2.612 .894 5.296 2 8\" /> <path d=\"M9 5a2.4 2.4 0 0 1 2 -1a2.4 2.4 0 0 1 2 1a2.4 2.4 0 0 0 2 1a2.4 2.4 0 0 0 2 -1a2.4 2.4 0 0 1 2 -1a2.4 2.4 0 0 1 2 1\" /> <path d=\"M3 21l19 0\" />",
  ...
  "traffic-cone": "<path d=\"M4 20l16 0\" /> <path d=\"M9.4 10l5.2 0\" /> <path d=\"M7.8 15l8.4 0\" /> <path d=\"M6 20l5 -15h2l5 15\" />",
  ...
  "backpack": "<path d=\"M5 18v-6a6 6 0 0 1 6 -6h2a6 6 0 0 1 6 6v6a3 3 0 0 1 -3 3h-8a3 3 0 0 1 -3 -3\" /> <path d=\"M10 6v-1a2 2 0 1 1 4 0v1\" /> <path d=\"M9 21v-4a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v4\" /> <path d=\"M11 10h2\" />",
  "chalkboard": "<path d=\"M8 19h-3a2 2 0 0 1 -2 -2v-10a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v11a1 1 0 0 1 -1 1\" /> <path d=\"M11 17a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v1a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1l0 -1\" />",
  "school-bell": "<path d=\"M4 17a3 3 0 0 0 3 3\" /> <path d=\"M14.805 6.37l2.783 -2.784a2 2 0 1 1 2.829 2.828l-2.784 2.786\" /> <path d=\"M16.505 7.495a5.105 5.105 0 0 1 .176 7.035l-.176 .184l-1.867 1.867a3.48 3.48 0 0 0 -1.013 2.234l-.008 .23v.934c0 .327 -.13 .64 -.36 .871a.51 .51 0 0 1 -.652 .06l-.07 -.06l-9.385 -9.384a.51 .51 0 0 1 0 -.722c.198 -.198 .456 -.322 .732 -.353l.139 -.008h.933c.848 0 1.663 -.309 2.297 -.864l.168 -.157l1.867 -1.867l.16 -.153a5.105 5.105 0 0 1 7.059 .153\" />",
  ...
  "math-symbols": "<path d=\"M3 12l18 0\" /> <path d=\"M12 3l0 18\" /> <path d=\"M16.5 4.5l3 3\" /> <path d=\"M19.5 4.5l-3 3\" /> <path d=\"M6 4l0 4\" /> <path d=\"M4 6l4 0\" /> <path d=\"M18 16l.01 0\" /> <path d=\"M18 20l.01 0\" /> <path d=\"M4 18l4 0\" />",
  ...
  "podium": "<path d=\"M5 8h14l-.621 2.485a2 2 0 0 1 -1.94 1.515h-8.878a2 2 0 0 1 -1.94 -1.515l-.621 -2.485\" /> <path d=\"M7 8v-2a3 3 0 0 1 3 -3\" /> <path d=\"M8 12l1 9\" /> <path d=\"M16 12l-1 9\" /> <path d=\"M7 21h10\" />",
  "flag-2": "<path d=\"M5 14h14v-9h-14v16\" />",
  "building-pavilion": "<path d=\"M3 21h7v-3a2 2 0 0 1 4 0v3h7\" /> <path d=\"M6 21l0 -9\" /> <path d=\"M18 21l0 -9\" /> <path d=\"M6 12h12a3 3 0 0 0 3 -3a9 8 0 0 1 -9 -6a9 8 0 0 1 -9 6a3 3 0 0 0 3 3\" />",
  ...
  "contract": "<path d=\"M8 21h-2a3 3 0 0 1 -3 -3v-1h5.5\" /> <path d=\"M17 8.5v-3.5a2 2 0 1 1 2 2h-2\" /> <path d=\"M19 3h-11a3 3 0 0 0 -3 3v11\" /> <path d=\"M9 7h4\" /> <path d=\"M9 11h4\" /> <path d=\"M18.42 12.61a2.1 2.1 0 0 1 2.97 2.97l-6.39 6.42h-3v-3l6.42 -6.39\" />",
  ...
  "hotel-service": "<path d=\"M8.5 10a1.5 1.5 0 0 1 -1.5 -1.5a5.5 5.5 0 0 1 11 0v10.5a2 2 0 0 1 -2 2h-7a2 2 0 0 1 -2 -2v-2c0 -1.38 .71 -2.444 1.88 -3.175l4.424 -2.765c1.055 -.66 1.696 -1.316 1.696 -2.56a2.5 2.5 0 1 0 -5 0a1.5 1.5 0 0 1 -1.5 1.5\" />",
}
...
export const ICON_HINTS: [RegExp, string][] = [
  // 行业专属关键词放最前面——这是个"第一个命中就返回"的顺序数组，真实文案是长句，
  // 大概率会顺带命中后面那些"增长/确保/机制"这类泛用词，行业词放在数组末尾等于
  // 永远轮不到（真实农业大纲测试过：种植/灌溉这些词全被前面的泛用词抢先命中，
  // 一个农业图标都没用上），所以行业细分关键词必须排在通用词前面才有意义。
  [/拖拉机|农机|机械化|收割机/, "tractor"],
  [/小麦|麦子|粮食|谷物|丰收|耕种/, "wheat"],
  [/种植|播种|育苗|栽培|作物/, "plant"],
  [/农场|牧场|养殖场|围栏|畜牧/, "fence"],
  [/果园|水果|果树|果品/, "apple"],
  [/蔬菜|农产品|果蔬/, "carrot"],
  [/家禽|养鸡|禽类|禽蛋/, "egg"],
  [/渔业|水产|捕捞|养鱼/, "fish"],
  [/股票|证券|大盘|涨跌|K线/, "chart-candle"],
  [/税率|税务|征税|利率/, "percentage"],
  [/现金|流水|营收|收入/, "cash"],
  [/别墅|洋房|小区|社区/, "building-cottage"],
  [/户型|楼层|层高/, "stairs"],
  [/合同|协议|签约|条款/, "contract"],
  [/标签|价签|吊牌/, "tag"],
  [/促销|折扣|满减|优惠/, "discount"],
  [/门店|店铺|连锁|专柜/, "building-store"],
  [/招聘|入职|新员工|应聘/, "user-plus"],
  [/门票|景区|景点|打卡/, "ticket"],
  [/酒店|住宿|客房|民宿/, "hotel-service"],
  [/山川|徒步|登山|自然风光/, "mountain"],
  [/书包|开学|上学/, "backpack"],
  [/黑板|课堂|讲台/, "chalkboard"],
  [/校铃|铃声|课间/, "school-bell"],
  [/书籍|教材|课本|藏书/, "books"],
  [/识字|启蒙|拼音|字母/, "abc"],
  [/数学|运算|算术|公式/, "math-symbols"],
  [/法槌|判决|裁决|问责/, "gavel"],
  [/主席台|发言台|大会|宣讲/, "podium"],
  [/旗帜|插旗|标杆/, "flag-2"],
  [/会堂|礼堂|活动中心/, "building-pavilion"],
  [/党员|群众组织|基层组织|支部/, "users-group"],
  [/决议|工作清单|三会一课/, "clipboard-list"],
  ...
  [/思维|大脑|智力|头脑/, "brain"],
  [/人工智能|智能化|机器人|自动化/, "robot"],
  [/汽车|驾驶|自驾|新能源车/, "car"],
  [/公交|客车|校车/, "bus"],
  [/航空|飞机|出差|机场/, "plane"],
  [/工厂|制造|车间|产线/, "building-factory"],
  [/支付|刷卡|信用卡|消费/, "credit-card"],
  [/发票|报销|账单|票据/, "receipt"],
  [/银行|信贷|贷款|金融机构/, "building-bank"],
  [/体温|气温|发烧|测温/, "thermometer"],
  [/降雨|暴雨|防汛|汛情/, "cloud-rain"],
  [/施工|围挡|路障|警示/, "traffic-cone"],
  [/联网|组网|物联网/, "network"],
  [/隐私|加密|保密|数据安全/, "shield-lock"],
  [/整合|拼图|集成/, "puzzle"],
  [/达标|奖章|勋章/, "medal"],
  [/演讲|宣讲|发言|讲话/, "microphone"],
  [/办公|远程办公|居家办公/, "device-laptop"],
  [/零售|购物|电商/, "shopping-bag"],
  [/地图|区域|规划|布局/, "map"],
]
